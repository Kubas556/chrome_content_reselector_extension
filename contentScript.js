let bottomMessage = `<div id="fuck" style="width: 3.5rem;height: 3.5rem;border-radius: 100%;background: white;box-shadow: 0px 0px 10px -1px black;right: 1rem;bottom: 1rem;position: fixed;"><div title='fucked by my extension' style="width: 3.5rem;background:url('${chrome.runtime.getURL(
    "icon32.png"
